...
podanymi w książce \cite{dragonbook}.
\begin{itemize}
  ...
  \item[] \textbf{generacja kodu pośredniego} -- proces tłumaczenia drzewa AST na język pośredni, w kompilatorze
  NianioLanga nazywana \textbf{translacją}
...
Drugą ważną kwestią była decyzja co do przeniesienia opcjonalności typów
...
o $10^8$ iteracjach. Programym, na których wykonane zostały testy są zamieszczone na listingach
...
\begin{itemize}
  ...
  \begin{itemize}
   ...
   \item Korekty pracy licencjackiej
  \end{itemize}
