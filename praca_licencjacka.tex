...
kompilację jego zmiennych do efektywnych konstrukcji ęzyka C przy zachowaniu jego podstawowych cech.
...
do osiągniecia zamierzonych celów i sposób implmementacji tych zmian w kompilatorze.
\end{abstract}
