...
które na obecnych procesorach wykonują się w czasie jednego cyklu procesora. Użycie typu języka C
...
Z tego względu została podjęta decyzja o nie powielaniu istniejącej implementacji i wykorzystaniu
tej już istniejącej.
...
Na przykład, poniższy kod zostanie skompilowany do ciągu operacji na mniej efektywnym typie
...
\begin{lstlisting}[caption={Kod kompilowany do typu \texttt{ImmT}}]
var x;
x = 'a';
x = 1;
x++;
...
wielu strujktur jest z góry znany) oraz zapewnia statyczną kontrolę typów także przez kompilator
...
maksymalną pojemność tablicy i wskaźnik na jej pierwszy element. Dodawane są również funkcje,
...
została zaimplmentowana w sposób opisany w \cite{cormen}: po przekroczeniu połowy dostępnego miejsca
tablica zostaje powiększona dwukrotnie. Dzięki temu operacja ta działa w zamortyzowanym czasie
stałym.
