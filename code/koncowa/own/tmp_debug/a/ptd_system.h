...
ImmT  ptd_system0add_create(ImmT  ___nl__im__0,tc_types0modules_t0type* ___ref___im__1,tc_types0errors_t0type* ___ref___im__2);
ImmT  ptd_system0add_create0ptr(int _num, ImmT *_tab);
